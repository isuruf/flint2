...
FLINT_DLL mpfr * _mpfr_vec_init(slong length, flint_mp_bitcnt_t prec);
...
FLINT_DLL void _mpfr_vec_scalar_mul_2exp(mpfr * res, const mpfr * vec, slong length, flint_mp_bitcnt_t exp);
