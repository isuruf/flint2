...
/* set p = 2^wn + 1 */
void set_p(mpz_t p, mp_size_t n, flint_mp_bitcnt_t w)
{
...
void ref_fft_butterfly_twiddle(mpz_t s, mpz_t t, mpz_t i1, mpz_t i2, 
                   mpz_t p, mp_size_t i, mp_size_t w, flint_mp_bitcnt_t b1, flint_mp_bitcnt_t b2)
{
   mpz_add(s, i1, i2);
   mpz_sub(t, i1, i2);
   mpz_mul_2exp(s, s, b1);
...
void ref_ifft_butterfly_twiddle(mpz_t s, mpz_t t, mpz_t i1, mpz_t i2, 
      mpz_t p, mp_size_t i, mp_size_t n, mp_size_t w, flint_mp_bitcnt_t b1, flint_mp_bitcnt_t b2)
{
