...
void ifft_mfa_truncate_sqrt2(mp_limb_t ** ii, mp_size_t n, flint_mp_bitcnt_t w,
   mp_limb_t ** t1, mp_limb_t ** t2, mp_limb_t ** temp, mp_size_t n1, mp_size_t trunc)
{
   mp_size_t i, j, s;
   mp_size_t n2 = (2*n)/n1;
   mp_size_t trunc2 = (trunc - 2*n)/n1;
   flint_mp_bitcnt_t depth = 0;
   flint_mp_bitcnt_t depth2 = 0;
   flint_mp_bitcnt_t limbs = (w*n)/FLINT_BITS;
...
void ifft_mfa_truncate_sqrt2_outer(mp_limb_t ** ii, mp_size_t n, flint_mp_bitcnt_t w,
   mp_limb_t ** t1, mp_limb_t ** t2, mp_limb_t ** temp, mp_size_t n1, mp_size_t trunc)
{
   mp_size_t i, j;
   mp_size_t n2 = (2*n)/n1;
