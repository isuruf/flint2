...
public:
    ...
    flint_mp_bitcnt_t bits() const
        {return fmpz_bits(this->evaluate()._fmpz());}
    flint_mp_bitcnt_t size() const
        {return fmpz_size(this->evaluate()._fmpz());}
    flint_mp_bitcnt_t val2() const
    ...
    static FLINT_FIVEARY_ENABLE_RETTYPE(fmpzxx_bit_unpack,
        Arg1, Arg2, flint_mp_bitcnt_t, int, bool)
    bit_unpack(const Arg1& arr, const Arg2& bits,
            flint_mp_bitcnt_t shift = 0, int negate = 0, bool borrow = false)
    {
        return fmpzxx_bit_unpack(arr, bits, shift, negate, borrow);
    }
    template<class Arg1, class Arg2>
    static FLINT_THREEARY_ENABLE_RETTYPE(fmpzxx_bit_unpack_unsigned,
        Arg1, Arg2, flint_mp_bitcnt_t)
    bit_unpack_unsigned(const Arg1& arr, const Arg2& bits, flint_mp_bitcnt_t shift = 0)
    {
...
template<class Fmpz>
inline typename mp::enable_if<traits::is_fmpzxx<Fmpz>, flint_mp_bitcnt_t>::type
bits(const Fmpz& a)
{
    return a.bits();
}
...
template<class Fmpz>
inline bool bit_pack(std::vector<mp_limb_t>& arr, flint_mp_bitcnt_t bits,
        const Fmpz& coeff, flint_mp_bitcnt_t shift = 0, int negate = 0,
        bool borrow = false,
...
FLINT_DEFINE_FIVEARY_EXPR_COND5(fmpzxx_bit_unpack_op, rdetail::bool_fmpzxx_pair,
        rdetail::is_mplimb_t_vec, traits::fits_into_flint_mp_bitcnt_t,
        traits::fits_into_flint_mp_bitcnt_t, traits::is_integer, tools::is_bool,
...
FLINT_DEFINE_THREEARY_EXPR_COND3(fmpzxx_bit_unpack_unsigned_op, fmpzxx,
        rdetail::is_mplimb_t_vec, traits::fits_into_flint_mp_bitcnt_t,
        traits::fits_into_flint_mp_bitcnt_t,
