...
FLINT_DLL void _fmpq_randtest(fmpz_t num, fmpz_t den, flint_rand_t state, flint_mp_bitcnt_t bits);

FLINT_DLL void fmpq_randtest(fmpq_t res, flint_rand_t state, flint_mp_bitcnt_t bits);

FLINT_DLL void fmpq_randtest_not_zero(fmpq_t res, flint_rand_t state, flint_mp_bitcnt_t bits);

FLINT_DLL void _fmpq_randbits(fmpz_t num, fmpz_t den, flint_rand_t state, flint_mp_bitcnt_t bits);

FLINT_DLL void fmpq_randbits(fmpq_t res, flint_rand_t state, flint_mp_bitcnt_t bits);
...
FLINT_DLL void fmpq_mul_2exp(fmpq_t res, const fmpq_t x, flint_mp_bitcnt_t exp);

FLINT_DLL void fmpq_div_2exp(fmpq_t res, const fmpq_t x, flint_mp_bitcnt_t exp);
...
FLINT_DLL flint_mp_bitcnt_t fmpq_height_bits(const fmpq_t x);
