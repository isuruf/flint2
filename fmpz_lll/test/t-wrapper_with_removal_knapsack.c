    ...
    for (i = 0; i < 1 * flint_test_multiplier(); i++)
    {
        ...
        if (fl->rt == GRAM)
        {
            if (n_randint(state, 2))
            {
                ...
                newd =
                    fmpz_lll_wrapper_with_removal_knapsack(mat, U, bound, fl);
            ...
            else
            {
                fmpz_mat_gram(mat, mat);
                newd =
                    fmpz_lll_wrapper_with_removal_knapsack(mat, NULL, bound,
                                                           fl);
            }
            result =
    ...
    for (i = 0; i < 10 * flint_test_multiplier(); i++)
    {
        ...
        if (fl->rt == GRAM)
        {
            ...
            if (n_randint(state, 2))
            {
                ...
                newd =
                    fmpz_lll_wrapper_with_removal_knapsack(gmat, U, bound, fl);
            ...
            {
                newd =
                    fmpz_lll_wrapper_with_removal_knapsack(gmat, NULL, bound,
                                                           fl);
            }
            result =
