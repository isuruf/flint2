...
main(void)
{
    ...
    flint_printf("wrapper_with_removal....");
    fflush(stdout);
    ...
    for (i = 0; i < 1 * flint_test_multiplier(); i++)
    {
        ...
        if (fl->rt == GRAM)
        {
            if (n_randint(state, 2))
            {
                ...
                newd = fmpz_lll_wrapper_with_removal(mat, U, bound, fl);
            ...
            {
                fmpz_mat_gram(mat, mat);
                newd = fmpz_lll_wrapper_with_removal(mat, NULL, bound, fl);
            }
            result =
    ...
    for (i = 0; i < 10 * flint_test_multiplier(); i++)
    {
        ...
        if (fl->rt == GRAM)
        {
            ...
            if (n_randint(state, 2))
            {
                ...
                newd = fmpz_lll_wrapper_with_removal(gmat, U, bound, fl);
            ...
            {
                newd = fmpz_lll_wrapper_with_removal(gmat, NULL, bound, fl);
            }
            result =
