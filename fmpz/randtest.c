...
void
fmpz_randtest(fmpz_t f, flint_rand_t state, flint_mp_bitcnt_t bits)
{
    ulong m;
...
void
fmpz_randtest_unsigned(fmpz_t f, flint_rand_t state, flint_mp_bitcnt_t bits)
{
    ulong m;
...
void
fmpz_randtest_not_zero(fmpz_t f, flint_rand_t state, flint_mp_bitcnt_t bits)
{
    if (bits == 0)
    {
