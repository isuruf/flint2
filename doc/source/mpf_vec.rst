...
.. function:: void _mpf_vec_randtest(mpf * f, flint_rand_t state, slong len, flint_mp_bitcnt_t bits)
...
.. function:: int _mpf_vec_approx_equal(const mpf * vec1, const mpf * vec2, slong len, flint_mp_bitcnt_t bits)
...
.. function:: void _mpf_vec_scalar_mul_2exp(mpf * res, const mpf * vec, slong len, flint_mp_bitcnt_t exp)
...
.. function:: int _mpf_vec_dot2(mpf_t res, const mpf * vec1, const mpf * vec2, slong len2, flint_mp_bitcnt_t prec)
...
.. function:: void _mpf_vec_norm2(mpf_t res, mpf * vec, slong len, flint_mp_bitcnt_t prec)
