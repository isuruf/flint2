...
.. function:: void mpf_mat_init(mpf_mat_t mat, slong rows, slong cols, flint_mp_bitcnt_t prec)
...
.. function:: void mpf_mat_randtest(mpf_mat_t mat, flint_ranmpf_t state, flint_mp_bitcnt_t bits)
...
.. function:: int mpf_mat_approx_equal(const mpf_mat_t mat1, const mpf_mat_t mat2, flint_mp_bitcnt_t bits)
