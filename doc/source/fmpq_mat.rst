...
.. function:: void fmpq_mat_randbits(fmpq_mat_t mat, flint_rand_t state, flint_mp_bitcnt_t bits)

    This is equivalent to applying ``fmpq_randbits`` to all entries
    in the matrix.

.. function:: void fmpq_mat_randtest(fmpq_mat_t mat, flint_rand_t state, flint_mp_bitcnt_t bits)
