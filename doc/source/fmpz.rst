...
.. function:: void fmpz_randbits(fmpz_t f, flint_rand_t state, flint_mp_bitcnt_t bits)

    Generates a random signed integer whose absolute value has precisely
    the given number of bits.

.. function:: void fmpz_randtest(fmpz_t f, flint_rand_t state, flint_mp_bitcnt_t bits)

    Generates a random signed integer whose absolute value has a number
    of bits which is random from `0` up to ``bits`` inclusive.

.. function:: void fmpz_randtest_unsigned(fmpz_t f, flint_rand_t state, flint_mp_bitcnt_t bits)

    Generates a random unsigned integer whose value has a number
    of bits which is random from `0` up to ``bits`` inclusive.

.. function:: void fmpz_randtest_not_zero(fmpz_t f, flint_rand_t state, flint_mp_bitcnt_t bits)
...
.. function:: void fmpz_randprime(fmpz_t f, flint_rand_t state, flint_mp_bitcnt_t bits, int proved)
...
.. function:: flint_mp_bitcnt_t fmpz_bits(const fmpz_t f)
...
.. function:: flint_mp_bitcnt_t fmpz_val2(const fmpz_t f)
...
.. function:: int fmpz_bit_pack(mp_limb_t * arr, flint_mp_bitcnt_t shift, flint_mp_bitcnt_t bits, fmpz_t coeff, int negate, int borrow)
...
.. function:: int fmpz_bit_unpack(fmpz_t coeff, mp_limb_t * arr, flint_mp_bitcnt_t shift, flint_mp_bitcnt_t bits, int negate, int borrow)
...
.. function:: void fmpz_bit_unpack_unsigned(fmpz_t coeff, const mp_limb_t * arr, flint_mp_bitcnt_t shift, flint_mp_bitcnt_t bits)
