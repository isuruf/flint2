...
.. function:: void fmpq_poly_randtest(fmpq_poly_t f, flint_rand_t state, slong len, flint_mp_bitcnt_t bits)
...
.. function:: void fmpq_poly_randtest_unsigned(fmpq_poly_t f, flint_rand_t state, slong len, flint_mp_bitcnt_t bits)
...
.. function:: void fmpq_poly_randtest_not_zero(fmpq_poly_t f, flint_rand_t state, slong len, flint_mp_bitcnt_t bits)
