...
.. function:: void _fmpq_vec_randtest(fmpq * f, flint_rand_t state, slong len, flint_mp_bitcnt_t bits)
...
.. function:: void _fmpq_vec_randtest_uniq_sorted(fmpq * vec, flint_rand_t state, slong len, flint_mp_bitcnt_t bits)
