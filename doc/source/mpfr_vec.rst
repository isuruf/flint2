...
.. function:: mpfr * _mpfr_vec_init(slong len, flint_mp_bitcnt_t prec)
...
.. function:: void _mpfr_vec_scalar_mul_2exp(mpfr * res, const mpfr * vec, slong len, flint_mp_bitcnt_t exp)
