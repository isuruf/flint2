...
.. function:: flint_mp_bitcnt_t nmod_poly_max_bits(const nmod_poly_t poly)
...
.. function:: void _nmod_poly_bit_pack(mp_ptr res, mp_srcptr poly, slong len, flint_mp_bitcnt_t bits)
...
.. function:: void nmod_poly_bit_pack(fmpz_t f, const nmod_poly_t poly, flint_mp_bitcnt_t bit_size)

    Packs ``poly`` into bitfields of size ``bit_size``, writing the
    result to ``f``.

.. function:: void nmod_poly_bit_unpack(nmod_poly_t poly, const fmpz_t f, flint_mp_bitcnt_t bit_size)
...
.. function:: void _nmod_poly_mul_KS(mp_ptr out, mp_srcptr in1, slong len1, mp_srcptr in2, slong len2, flint_mp_bitcnt_t bits, nmod_t mod)
...
.. function:: void nmod_poly_mul_KS(nmod_poly_t res, const nmod_poly_t poly1, const nmod_poly_t poly2, flint_mp_bitcnt_t bits)
...
.. function:: void _nmod_poly_mullow_KS(mp_ptr out, mp_srcptr in1, slong len1, mp_srcptr in2, slong len2, flint_mp_bitcnt_t bits, slong n, nmod_t mod)
...
.. function:: void nmod_poly_mullow_KS(nmod_poly_t res, const nmod_poly_t poly1, const nmod_poly_t poly2, flint_mp_bitcnt_t bits, slong n)
