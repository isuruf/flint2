...
.. function:: mp_size_t flint_mpn_remove_2exp(mp_ptr x, mp_size_t xsize, flint_mp_bitcnt_t *bits)
...
.. function:: void flint_mpn_urandomb(mp_limb_t *rp, gmp_randstate_t state, flint_mp_bitcnt_t n)
