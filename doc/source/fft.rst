...
.. function:: mp_size_t fft_split_bits(mp_limb_t ** poly, mp_srcptr limbs, mp_size_t total_limbs, flint_mp_bitcnt_t bits, mp_size_t output_limbs)
...
.. function:: void fft_combine_bits(mp_limb_t * res, mp_limb_t ** poly, slong length, flint_mp_bitcnt_t bits, mp_size_t output_limbs, mp_size_t total_limbs)
...
.. function:: void mpn_mul_2expmod_2expp1(mp_limb_t * t, mp_limb_t * i1, mp_size_t limbs, flint_mp_bitcnt_t d)
...
.. function:: void mpn_div_2expmod_2expp1(mp_limb_t * t, mp_limb_t * i1, mp_size_t limbs, flint_mp_bitcnt_t d)
...
.. function:: void fft_adjust(mp_limb_t * r, mp_limb_t * i1, mp_size_t i, mp_size_t limbs, flint_mp_bitcnt_t w)
...
.. function:: void fft_adjust_sqrt2(mp_limb_t * r, mp_limb_t * i1, mp_size_t i, mp_size_t limbs, flint_mp_bitcnt_t w, mp_limb_t * temp)
...
.. function:: void fft_butterfly(mp_limb_t * s, mp_limb_t * t, mp_limb_t * i1, mp_limb_t * i2, mp_size_t i, mp_size_t limbs, flint_mp_bitcnt_t w)
...
.. function:: void ifft_butterfly(mp_limb_t * s, mp_limb_t * t, mp_limb_t * i1, mp_limb_t * i2, mp_size_t i, mp_size_t limbs, flint_mp_bitcnt_t w)
...
.. function:: void fft_radix2(mp_limb_t ** ii, mp_size_t n, flint_mp_bitcnt_t w, mp_limb_t ** t1, mp_limb_t ** t2)
...
.. function:: void fft_truncate(mp_limb_t ** ii,  mp_size_t n, flint_mp_bitcnt_t w, mp_limb_t ** t1, mp_limb_t ** t2, mp_size_t trunc)
...
.. function:: void fft_truncate1(mp_limb_t ** ii, mp_size_t n, flint_mp_bitcnt_t w, mp_limb_t ** t1, mp_limb_t ** t2, mp_size_t trunc)

    As for ``fft_radix2`` except that only the first ``trunc``
    coefficients of the output are computed. The transform still needs all
    `2n` input coefficients to be specified.

.. function:: void ifft_radix2(mp_limb_t ** ii, mp_size_t n, flint_mp_bitcnt_t w, mp_limb_t ** t1, mp_limb_t ** t2)
...
.. function:: void ifft_truncate(mp_limb_t ** ii, mp_size_t n, flint_mp_bitcnt_t w, mp_limb_t ** t1, mp_limb_t ** t2, mp_size_t trunc)
...
.. function:: void ifft_truncate1(mp_limb_t ** ii, mp_size_t n, flint_mp_bitcnt_t w, mp_limb_t ** t1, mp_limb_t ** t2, mp_size_t trunc)
...
.. function:: void fft_butterfly_sqrt2(mp_limb_t * s, mp_limb_t * t, mp_limb_t * i1, mp_limb_t * i2, mp_size_t i, mp_size_t limbs, flint_mp_bitcnt_t w, mp_limb_t * temp)
...
.. function:: void ifft_butterfly_sqrt2(mp_limb_t * s, mp_limb_t * t, mp_limb_t * i1, mp_limb_t * i2, mp_size_t i, mp_size_t limbs, flint_mp_bitcnt_t w, mp_limb_t * temp)
...
.. function:: void fft_truncate_sqrt2(mp_limb_t ** ii, mp_size_t n, flint_mp_bitcnt_t w, mp_limb_t ** t1, mp_limb_t ** t2, mp_limb_t ** temp, mp_size_t trunc)
...
.. function:: void ifft_truncate_sqrt2(mp_limb_t ** ii, mp_size_t n, flint_mp_bitcnt_t w, mp_limb_t ** t1, mp_limb_t ** t2, mp_limb_t ** temp, mp_size_t trunc)
...
.. function:: void fft_butterfly_twiddle(mp_limb_t * u, mp_limb_t * v, mp_limb_t * s, mp_limb_t * t, mp_size_t limbs, flint_mp_bitcnt_t b1, flint_mp_bitcnt_t b2)
...
.. function:: void ifft_butterfly_twiddle(mp_limb_t * u, mp_limb_t * v, mp_limb_t * s, mp_limb_t * t, mp_size_t limbs, flint_mp_bitcnt_t b1, flint_mp_bitcnt_t b2)
...
.. function:: void fft_radix2_twiddle(mp_limb_t ** ii, mp_size_t is, mp_size_t n, flint_mp_bitcnt_t w, mp_limb_t ** t1, mp_limb_t ** t2, mp_size_t ws, mp_size_t r, mp_size_t c, mp_size_t rs)
...
.. function:: void ifft_radix2_twiddle(mp_limb_t ** ii, mp_size_t is, mp_size_t n, flint_mp_bitcnt_t w, mp_limb_t ** t1, mp_limb_t ** t2, mp_size_t ws, mp_size_t r, mp_size_t c, mp_size_t rs)
...
.. function:: void fft_truncate1_twiddle(mp_limb_t ** ii, mp_size_t is, mp_size_t n, flint_mp_bitcnt_t w, mp_limb_t ** t1, mp_limb_t ** t2, mp_size_t ws, mp_size_t r, mp_size_t c, mp_size_t rs, mp_size_t trunc)

    As per ``fft_radix2_twiddle`` except that the transform is truncated 
    as per\\ ``fft_truncate1``.

.. function:: void ifft_truncate1_twiddle(mp_limb_t ** ii, mp_size_t is, mp_size_t n, flint_mp_bitcnt_t w, mp_limb_t ** t1, mp_limb_t ** t2, mp_size_t ws, mp_size_t r, mp_size_t c, mp_size_t rs, mp_size_t trunc)

    As per ``ifft_radix2_twiddle`` except that the transform is truncated
    as per\\ ``ifft_truncate1``.

.. function:: void fft_mfa_truncate_sqrt2(mp_limb_t ** ii, mp_size_t n, flint_mp_bitcnt_t w, mp_limb_t ** t1, mp_limb_t ** t2, mp_limb_t ** temp, mp_size_t n1, mp_size_t trunc)
...
.. function:: void ifft_mfa_truncate_sqrt2(mp_limb_t ** ii, mp_size_t n, flint_mp_bitcnt_t w, mp_limb_t ** t1, mp_limb_t ** t2, mp_limb_t ** temp, mp_size_t n1, mp_size_t trunc)
...
.. function:: void fft_mfa_truncate_sqrt2_outer(mp_limb_t ** ii, mp_size_t n, flint_mp_bitcnt_t w, mp_limb_t ** t1, mp_limb_t ** t2, mp_limb_t ** temp, mp_size_t n1, mp_size_t trunc)

    Just the outer layers of ``fft_mfa_truncate_sqrt2``.

.. function:: void fft_mfa_truncate_sqrt2_inner(mp_limb_t ** ii, mp_limb_t ** jj, mp_size_t n, flint_mp_bitcnt_t w, mp_limb_t ** t1, mp_limb_t ** t2, mp_limb_t ** temp, mp_size_t n1, mp_size_t trunc, mp_limb_t * tt)

    The inner layers of ``fft_mfa_truncate_sqrt2`` and 
    ``ifft_mfa_truncate_sqrt2`` combined with pointwise mults.

.. function:: void ifft_mfa_truncate_sqrt2_outer(mp_limb_t ** ii, mp_size_t n, flint_mp_bitcnt_t w, mp_limb_t ** t1, mp_limb_t ** t2, mp_limb_t ** temp, mp_size_t n1, mp_size_t trunc)
...
.. function:: void fft_negacyclic(mp_limb_t ** ii, mp_size_t n, flint_mp_bitcnt_t w, mp_limb_t ** t1, mp_limb_t ** t2, mp_limb_t ** temp)
...
.. function:: void ifft_negacyclic(mp_limb_t ** ii, mp_size_t n, flint_mp_bitcnt_t w, mp_limb_t ** t1, mp_limb_t ** t2, mp_limb_t ** temp)
...
.. function:: void _fft_mulmod_2expp1(mp_limb_t * r1, mp_limb_t * i1, mp_limb_t * i2, mp_size_t r_limbs, flint_mp_bitcnt_t depth, flint_mp_bitcnt_t w)
...
.. function:: void mul_truncate_sqrt2(mp_ptr r1, mp_srcptr i1, mp_size_t n1, mp_srcptr i2, mp_size_t n2, flint_mp_bitcnt_t depth, flint_mp_bitcnt_t w)
...
.. function:: void mul_mfa_truncate_sqrt2(mp_ptr r1, mp_srcptr i1, mp_size_t n1, mp_srcptr i2, mp_size_t n2, flint_mp_bitcnt_t depth, flint_mp_bitcnt_t w)
