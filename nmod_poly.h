...
NMOD_POLY_INLINE
flint_mp_bitcnt_t nmod_poly_max_bits(const nmod_poly_t poly)
{
...
FLINT_DLL void _nmod_poly_bit_pack(mp_ptr res, mp_srcptr poly, 
                                                  slong len, flint_mp_bitcnt_t bits);

FLINT_DLL void _nmod_poly_bit_unpack(mp_ptr res, slong len, 
                                  mp_srcptr mpn, flint_mp_bitcnt_t bits, nmod_t mod);

FLINT_DLL void nmod_poly_bit_pack(fmpz_t f, const nmod_poly_t poly,
                   flint_mp_bitcnt_t bit_size);

FLINT_DLL void nmod_poly_bit_unpack(nmod_poly_t poly, const fmpz_t f, flint_mp_bitcnt_t bit_size);
...
FLINT_DLL void _nmod_poly_mul_KS(mp_ptr out, mp_srcptr in1, slong len1, 
                        mp_srcptr in2, slong len2, flint_mp_bitcnt_t bits, nmod_t mod);

FLINT_DLL void nmod_poly_mul_KS(nmod_poly_t res, 
             const nmod_poly_t poly1, const nmod_poly_t poly2, flint_mp_bitcnt_t bits);
...
FLINT_DLL void _nmod_poly_mullow_KS(mp_ptr out, mp_srcptr in1, slong len1,
               mp_srcptr in2, slong len2, flint_mp_bitcnt_t bits, slong n, nmod_t mod);

FLINT_DLL void nmod_poly_mullow_KS(nmod_poly_t res, const nmod_poly_t poly1, 
                             const nmod_poly_t poly2, flint_mp_bitcnt_t bits, slong n);
