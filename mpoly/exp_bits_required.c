...
*/
flint_mp_bitcnt_t mpoly_exp_bits_required_ui(const ulong * user_exp,
...
/*
    ...
    the returned number of bits includes space for a zero'd signed bit
*/
flint_mp_bitcnt_t mpoly_exp_bits_required_ffmpz(const fmpz * user_exp,
                                                        const mpoly_ctx_t mctx)
{
...
/*
    ...
    the returned number of bits includes space for a zero'd signed bit
*/
flint_mp_bitcnt_t mpoly_exp_bits_required_pfmpz(fmpz * const * user_exp,
                                                        const mpoly_ctx_t mctx)
{
    slong i, nvars = mctx->nvars;
    flint_mp_bitcnt_t exp_bits;
