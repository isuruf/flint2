...
void _mpoly_gen_shift_right(ulong * Aexp, flint_mp_bitcnt_t Abits, slong Alength,
...
void _mpoly_gen_shift_left(ulong * Aexp, flint_mp_bitcnt_t Abits, slong Alength,
                               slong var, ulong amount, const mpoly_ctx_t mctx)
{
    slong i, N;
    ulong *one;
