...
slong mpoly_monomial_index_ui(const ulong * Aexps, flint_mp_bitcnt_t Abits,
...
slong mpoly_monomial_index_pfmpz(const ulong * Aexps, flint_mp_bitcnt_t Abits,
...
slong mpoly_monomial_index_monomial(const ulong * Aexps, flint_mp_bitcnt_t Abits,
                        slong Alength, const ulong * Mexp, flint_mp_bitcnt_t Mbits,
