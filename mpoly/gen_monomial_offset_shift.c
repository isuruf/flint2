...
void mpoly_gen_monomial_sp(ulong * mexp, slong var, flint_mp_bitcnt_t bits,
...
slong mpoly_gen_offset_mp(slong var, flint_mp_bitcnt_t bits, const mpoly_ctx_t mctx)
{
    slong nvars = mctx->nvars;
