...
FLINT_DLL void fmpz_randbits(fmpz_t f, flint_rand_t state, flint_mp_bitcnt_t bits);

FLINT_DLL void fmpz_randm(fmpz_t f, flint_rand_t state, const fmpz_t m);

FLINT_DLL void fmpz_randtest(fmpz_t f, flint_rand_t state, flint_mp_bitcnt_t bits);

FLINT_DLL void fmpz_randtest_unsigned(fmpz_t f, flint_rand_t state, flint_mp_bitcnt_t bits);

FLINT_DLL void fmpz_randtest_not_zero(fmpz_t f, flint_rand_t state, flint_mp_bitcnt_t bits);
...
FLINT_DLL void fmpz_randprime(fmpz_t f, flint_rand_t state, 
                              flint_mp_bitcnt_t bits, int proved);
...
FLINT_DLL flint_mp_bitcnt_t fmpz_bits(const fmpz_t f);

FLINT_DLL flint_mp_bitcnt_t fmpz_val2(const fmpz_t x);
...
FLINT_DLL flint_mp_bitcnt_t fmpz_popcnt(const fmpz_t c);
...
FLINT_DLL int fmpz_bit_pack(mp_ptr arr, flint_mp_bitcnt_t shift, flint_mp_bitcnt_t bits,
                  const fmpz_t coeff, int negate, int borrow);

FLINT_DLL int fmpz_bit_unpack(fmpz_t coeff, mp_srcptr arr, flint_mp_bitcnt_t shift,
                    flint_mp_bitcnt_t bits, int negate, int borrow);

FLINT_DLL void fmpz_bit_unpack_unsigned(fmpz_t coeff, mp_srcptr arr, 
                              flint_mp_bitcnt_t shift, flint_mp_bitcnt_t bits);
