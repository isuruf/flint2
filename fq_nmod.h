...
FLINT_DLL void fq_nmod_bit_pack(fmpz_t f, const fq_nmod_t op, flint_mp_bitcnt_t bit_size,
                 const fq_nmod_ctx_t ctx);

FLINT_DLL void fq_nmod_bit_unpack(fq_nmod_t rop, const fmpz_t f, flint_mp_bitcnt_t bit_size,
                   const fq_nmod_ctx_t ctx);
