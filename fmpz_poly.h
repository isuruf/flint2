...
FLINT_DLL void _fmpz_poly_bit_pack(mp_ptr arr, const fmpz * poly,
                                slong len, flint_mp_bitcnt_t bit_size, int negate);

FLINT_DLL int _fmpz_poly_bit_unpack(fmpz * poly, slong len, 
                           mp_srcptr arr, flint_mp_bitcnt_t bit_size, int negate);

FLINT_DLL void _fmpz_poly_bit_unpack_unsigned(fmpz * poly, slong len, 
                                       mp_srcptr arr, flint_mp_bitcnt_t bit_size);
...
FLINT_DLL flint_mp_bitcnt_t _fmpz_poly_2norm_normalised_bits(const fmpz * poly, slong len);
