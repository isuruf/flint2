...
void _quadratic(fmpz_poly_t p, flint_rand_t state, flint_mp_bitcnt_t bits)
{
    fmpz *a, *b, *c;
...
void _even(fmpz_poly_t p, flint_rand_t state, slong len, flint_mp_bitcnt_t bits)
{
    slong n, i;
...
void fmpz_poly_randtest_no_real_root(fmpz_poly_t p, flint_rand_t state, slong len, flint_mp_bitcnt_t bits)
{
