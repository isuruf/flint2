...
cd mpir\build.vc14
msbuild.exe dll_mpir_gc/dll_mpir_gc.vcxproj /p:Configuration=Release /p:Platform=%PLATFORM% /p:PlatformToolset=v140 /verbosity:minimal
cd ..\..
...
cd mpfr\build.vc14
msbuild.exe dll_mpfr.sln /p:Configuration=Release /p:Platform=%PLATFORM% /p:PlatformToolset=v140 /verbosity:minimal
cd ..\..
