...
FMPQ_MPOLY_INLINE
void fmpq_mpoly_init3(fmpq_mpoly_t A, slong alloc, flint_mp_bitcnt_t bits,
                                                   const fmpq_mpoly_ctx_t ctx)
{
    fmpq_init(A->content);
...
void fmpq_mpoly_fit_bits(fmpq_mpoly_t A,
                                  flint_mp_bitcnt_t bits, const fmpq_mpoly_ctx_t ctx)
{
...
FLINT_DLL int fmpq_mpoly_repack_bits(fmpq_mpoly_t A, const fmpq_mpoly_t B,
                                flint_mp_bitcnt_t Abits, const fmpq_mpoly_ctx_t ctx);
