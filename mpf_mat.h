...
FLINT_DLL void mpf_mat_init(mpf_mat_t mat, slong rows, slong cols, flint_mp_bitcnt_t prec);
...
FLINT_DLL int mpf_mat_approx_equal(const mpf_mat_t mat1, const mpf_mat_t mat2, flint_mp_bitcnt_t bits);
...
FLINT_DLL void mpf_mat_randtest(mpf_mat_t mat, flint_rand_t state, flint_mp_bitcnt_t bits);
