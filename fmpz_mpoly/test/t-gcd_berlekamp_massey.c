...
main(void)
{
...

    {
        ...
        */
        ...
        fmpz_mpoly_mul(a, a, g, ctx);
        fmpz_mpoly_mul(b, b, g, ctx);
        gcd_check(g, a, b, ctx, 0, 0, "trigger unlucky ksub");
        ...
        */
        ...
        fmpz_mpoly_mul(a, a, g, ctx);
        fmpz_mpoly_mul(b, b, g, ctx);
        gcd_check(g, a, b, ctx, 0, 0, "trigger zipple no match");
        ...
        */
        ...
        fmpz_mpoly_mul(a, a, g, ctx);
        fmpz_mpoly_mul(b, b, g, ctx);
        gcd_check(g, a, b, ctx, 0, 0, "trigger ksub lc kill");
        ...
        fmpz_mpoly_mul(a, a, g, ctx);
        fmpz_mpoly_mul(b, b, g, ctx);
        gcd_check(g, a, b, ctx, 0, 0, "trigger ksub lc kill mod p");
        ...
        */
        ...
        fmpz_mpoly_mul(a, a, g, ctx);
        fmpz_mpoly_mul(b, b, g, ctx);
        gcd_check(g, a, b, ctx, 0, 0, "trigger gcd lc terms vanish mod p");
