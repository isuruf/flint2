...
FLINT_DLL void fq_bit_pack(fmpz_t f, const fq_t op, flint_mp_bitcnt_t bit_size,
            const fq_ctx_t ctx);

FLINT_DLL void fq_bit_unpack(fq_t rop, const fmpz_t f, flint_mp_bitcnt_t bit_size,
              const fq_ctx_t ctx);
