...
public:
    ...
    static fmpz_poly_matxx_expression randtest(slong rows, slong cols,
            frandxx& state, slong len, flint_mp_bitcnt_t bits)
    {
    ...
    static fmpz_poly_matxx_expression randtest_sparse(slong rows, slong cols,
            frandxx& state, slong len, flint_mp_bitcnt_t bits, float density)
    {
        fmpz_poly_matxx_expression res(rows, cols);
    ...
    void set_randtest(frandxx& state, slong len, flint_mp_bitcnt_t bits)
        {fmpz_poly_mat_randtest(_mat(), state._data(), len, bits);}
    void set_randtest_unsigned(frandxx& state, slong len, flint_mp_bitcnt_t bits)
        {fmpz_poly_mat_randtest_unsigned(_mat(), state._data(), len, bits);}
    void set_randtest_sparse(frandxx& state, slong len, flint_mp_bitcnt_t bits,
            float density)
