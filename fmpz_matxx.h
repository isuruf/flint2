...
public:
    ...
    static fmpz_matxx_expression randbits(slong rows, slong cols,
            frandxx& state, flint_mp_bitcnt_t bits)
    {
    ...
    static fmpz_matxx_expression randsimdioph(slong rows, slong cols,
            frandxx& state, flint_mp_bitcnt_t bits, flint_mp_bitcnt_t bits2)
    {
        fmpz_matxx_expression res(rows, cols);
    ...
    static fmpz_matxx_expression randntrulike(slong rows, slong cols,
            frandxx& state, flint_mp_bitcnt_t bits, ulong q)
    {
        fmpz_matxx_expression res(rows, cols);
    ...
    static fmpz_matxx_expression randajtai(slong rows, slong cols,
            frandxx& state, flint_mp_bitcnt_t bits, double alpha)
    {
        fmpz_matxx_expression res(rows, cols);
    ...
    static fmpz_matxx_expression randrank(slong rows, slong cols,
            frandxx& state, slong rank, flint_mp_bitcnt_t bits)
    {
        fmpz_matxx_expression res(rows, cols);
    ...
    void set_randbits(frandxx& state, flint_mp_bitcnt_t bits)
        {fmpz_mat_randbits(_mat(), state._data(), bits);}
    void set_randtest(frandxx& state, flint_mp_bitcnt_t bits)
        {fmpz_mat_randtest(_mat(), state._data(), bits);}
    void set_randintrel(frandxx& state, flint_mp_bitcnt_t bits)
        {fmpz_mat_randintrel(_mat(), state._data(), bits);}
    void set_randsimdioph(frandxx& state, flint_mp_bitcnt_t bits, flint_mp_bitcnt_t bits2)
        {fmpz_mat_randsimdioph(_mat(), state._data(), bits, bits2);}
    void set_randntrulike(frandxx& state, flint_mp_bitcnt_t bits, ulong q)
        {fmpz_mat_randntrulike(_mat(), state._data(), bits, q);}
    void set_randntrulike2(frandxx& state, flint_mp_bitcnt_t bits, ulong q)
        {fmpz_mat_randntrulike2(_mat(), state._data(), bits, q);}
    void set_randajtai(frandxx& state, flint_mp_bitcnt_t bits, double alpha)
        {fmpz_mat_randajtai(_mat(), state._data(), bits, alpha);}
    void set_randrank(frandxx& state, slong rank, flint_mp_bitcnt_t bits)
