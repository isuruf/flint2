...
FLINT_DLL void mpoly_monomial_randbits_fmpz(fmpz * exp, flint_rand_t state, flint_mp_bitcnt_t exp_bits, const mpoly_ctx_t mctx);
...
*/
MPOLY_INLINE
slong mpoly_words_per_exp_sp(flint_mp_bitcnt_t bits, const mpoly_ctx_t mctx)
{
    FLINT_ASSERT(0 < bits);
...
MPOLY_INLINE
slong mpoly_words_per_exp_mp(flint_mp_bitcnt_t bits, const mpoly_ctx_t mctx)
{
...
MPOLY_INLINE
slong mpoly_words_per_exp(flint_mp_bitcnt_t bits, const mpoly_ctx_t mctx)
{
    if (bits <= FLINT_BITS)
...
*/
MPOLY_INLINE
flint_mp_bitcnt_t mpoly_fix_bits(flint_mp_bitcnt_t bits, const mpoly_ctx_t mctx)
{
    FLINT_ASSERT(bits > 0);
    if (bits <= FLINT_BITS)
...
void mpoly_monomial_max_mp(ulong * exp1, const ulong * exp2, const ulong * exp3,
                                                     flint_mp_bitcnt_t bits, slong N)
{
    slong i, j;
...
MPOLY_INLINE
int mpoly_monomial_overflows_mp(ulong * exp_ptr, slong N, flint_mp_bitcnt_t bits)
{
...
int mpoly_monomial_divides_mp(ulong * exp_ptr, const ulong * exp2,
                                 const ulong * exp3, slong N, flint_mp_bitcnt_t bits)
{
    slong i;
...
FLINT_DLL flint_mp_bitcnt_t mpoly_gen_bits_required(slong var, const mpoly_ctx_t mctx);

FLINT_DLL void mpoly_gen_offset_shift_sp(slong * offset, slong * shift,
                          slong var, flint_mp_bitcnt_t bits, const mpoly_ctx_t mctx);

FLINT_DLL void mpoly_gen_monomial_offset_shift_sp(ulong * mexp, slong * offset,
           slong * shift, slong var, flint_mp_bitcnt_t bits, const mpoly_ctx_t mctx);

FLINT_DLL void mpoly_gen_monomial_sp(ulong * oneexp, slong var,
                                     flint_mp_bitcnt_t bits, const mpoly_ctx_t mctx);
...
FLINT_DLL flint_mp_bitcnt_t mpoly_exp_bits_required_ui(const ulong * user_exp,
                                                       const mpoly_ctx_t mctx);
FLINT_DLL flint_mp_bitcnt_t mpoly_exp_bits_required_ffmpz(const fmpz * user_exp,
                                                       const mpoly_ctx_t mctx);
FLINT_DLL flint_mp_bitcnt_t mpoly_exp_bits_required_pfmpz(fmpz * const * user_exp,
                                                       const mpoly_ctx_t mctx);

FLINT_DLL void mpoly_pack_vec_ui(ulong * exp1, const ulong * exp2, slong bits,
                                                     slong nfields, slong len);
FLINT_DLL void mpoly_pack_vec_fmpz(ulong * exp1, const fmpz * exp2, flint_mp_bitcnt_t bits,
                                                     slong nfields, slong len);

FLINT_DLL void mpoly_unpack_vec_ui(ulong * exp1, const ulong * exp2, slong bits,
                                                     slong nfields, slong len);
FLINT_DLL void mpoly_unpack_vec_fmpz(fmpz * exp1, const ulong * exp2, flint_mp_bitcnt_t bits,
                                                     slong nfields, slong len);
...
FLINT_DLL slong mpoly_monomial_index_ui(const ulong * Aexp, flint_mp_bitcnt_t Abits,
                     slong Alength, const ulong * exp, const mpoly_ctx_t mctx);

FLINT_DLL slong mpoly_monomial_index_pfmpz(const ulong * Aexp, flint_mp_bitcnt_t Abits,
                    slong Alength, fmpz * const * exp, const mpoly_ctx_t mctx);

FLINT_DLL slong mpoly_monomial_index_monomial(const ulong * Aexp,
                      flint_mp_bitcnt_t Abits, slong Alength, const ulong * Mexp,
                                    flint_mp_bitcnt_t Mbits, const mpoly_ctx_t mctx);

FLINT_DLL void mpoly_min_fields_ui_sp(ulong * min_fields, const ulong * poly_exps,
                          slong len, flint_mp_bitcnt_t bits, const mpoly_ctx_t mctx);
...
FLINT_DLL slong mpoly_degree_si(const ulong * poly_exps,
               slong len, flint_mp_bitcnt_t bits, slong var, const mpoly_ctx_t mctx);
...
FLINT_DLL void mpoly_monomials_deflation(fmpz * shift, fmpz * stride,
                        const ulong * Aexps, flint_mp_bitcnt_t Abits, slong Alength,
                                                       const mpoly_ctx_t mctx);

FLINT_DLL void mpoly_monomials_deflate(ulong * Aexps, flint_mp_bitcnt_t Abits,
                        const ulong * Bexps, flint_mp_bitcnt_t Bbits, slong Blength,
              const fmpz * shift, const fmpz * stride, const mpoly_ctx_t mctx);

FLINT_DLL void mpoly_monomials_inflate(ulong * Aexps, flint_mp_bitcnt_t Abits,
                        const ulong * Bexps, flint_mp_bitcnt_t Bbits, slong Blength,
              const fmpz * shift, const fmpz * stride, const mpoly_ctx_t mctx);

FLINT_DLL void _mpoly_gen_shift_right(ulong * Aexp, flint_mp_bitcnt_t Abits,
               slong Alength, slong var, ulong amount, const mpoly_ctx_t mctx);

FLINT_DLL void _mpoly_gen_shift_left(ulong * Aexp, flint_mp_bitcnt_t Abits,
               slong Alength, slong var, ulong amount, const mpoly_ctx_t mctx);

FLINT_DLL int mpoly_monomial_cmp_general(ulong * Aexp, flint_mp_bitcnt_t Abits,
                      ulong * Bexp, flint_mp_bitcnt_t Bbits, const mpoly_ctx_t mctx);
