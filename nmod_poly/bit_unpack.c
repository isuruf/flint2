...
void
_nmod_poly_bit_unpack(mp_ptr res, slong len, mp_srcptr mpn, flint_mp_bitcnt_t bits,
                      nmod_t mod)
{
    slong i;
...
void
nmod_poly_bit_unpack(nmod_poly_t poly, const fmpz_t f, flint_mp_bitcnt_t bit_size)
{
    slong len;
    mpz_t tmp;
