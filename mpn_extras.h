...
FLINT_DLL mp_size_t flint_mpn_remove_2exp(mp_ptr x, mp_size_t xsize, flint_mp_bitcnt_t *bits);
...
FLINT_DLL int flint_mpn_mulmod_2expp1_basecase(mp_ptr xp, mp_srcptr yp, mp_srcptr zp, 
    int c, flint_mp_bitcnt_t b, mp_ptr tp);
...
MPN_EXTRAS_INLINE
void flint_mpn_urandomb(mp_limb_t *rp, gmp_randstate_t state, flint_mp_bitcnt_t n)
{
  __mpz_struct str;
  str._mp_d = rp;
